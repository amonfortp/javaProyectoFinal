...
public class LDAP {
	 ...
	 * 
	 * @param usuario  login del usuario a validar
	 ...
	 * 
	 * @param searchBase   Base de busqueda por ejemplo "ou=Users"
	 * @param searchFilter Filtro de busqueda, por ejemplo "uid=jalonso"
	 * @param attributeID  Atributo del que se desea obtener su valor, por ejemplo
	 *                     "cn"
	 * @return Valor almacenado en LDAP en el atributo para la busqueda realizada
	 */
	 ...
	 * 
	 * @param persona Persona donde se añadiran los valores alamacenados segun su
	 *                UID
	...
	private void rellenarDatosAlumno(Persona persona, Attributes attribs) {
		...
		String value = null;
		AlumnoLDAP p = (AlumnoLDAP) persona;
	 ...
	 * 
	 * @param grupo Grupo del que se desea obtener los diferentes usuarios, por
	 *              ejemplo "Alumnos"
